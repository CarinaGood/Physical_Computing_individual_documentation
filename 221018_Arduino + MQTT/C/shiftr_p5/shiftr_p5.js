...
// MQTT client details:
let broker = {
  hostname: 'good7.cloud.shiftr.io',
  port: 443
 };
...
let circleX, circleY, circle_diameter;
...
function onMessageArrived(message) {
  ...
  if (receivedMessage.startsWith("posX")) {
   ...
   console.log(circleX);
   remoteMsg.html("posX: " + circleX + ", posY: " + circleY + " ,diameter: " + circle_diameter);
